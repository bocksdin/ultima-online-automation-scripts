...
bad_slayers = ['spider slayer', 'terathan slayer', 'ophidian slayer', 'poison elemental slayer', 'blood elemental slayer', 'water elemental slayer', 'lizardman slayer', 'orc slayer', 'air elemental slayer', 'gargoyle slayer', 'earth elemental slayer', 'snow elemental slayer', 'fire elemental slayer', 'scorpion slayer', 'troll slayer', 'ogre slayer', 'snake slayer']
...
while hammer is not None:
    ...
    if dark_sapphire is None or dark_sapphire.Amount < 1:
        Items.Move(Items.FindByID(0x3192,0x0000,ingots_container,0,0),Player.Backpack.Serial,100)
        Misc.Pause(1000)
