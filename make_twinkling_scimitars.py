...
extra_tools_container = 0x44297976
...
good_stats = [
    ...
    [Attribute('slayer'), Attribute('stamina leech'), Attribute('harm')],
    ...
    [Attribute('slayer'), Attribute('mana leech'), Attribute('harm')],
    ...
    [Attribute('area'), Attribute('mana leech'), Attribute('harm')],
    ...
    [Attribute('area'), Attribute('stamina leech'), Attribute('harm')],
    ...
    [Attribute('swing speed'), Attribute('mana leech'), Attribute('harm')],
    ...
    [Attribute('swing speed'), Attribute('stamina leech'), Attribute('harm')],
    ...
    [Attribute('stamina leech'), Attribute('mana leech'), Attribute('harm')],
    ...
    [Attribute('stamina leech'), Attribute('life leech'), Attribute('harm')],
    ...
    [Attribute('mana leech'), Attribute('life leech'), Attribute('harm')],
...
while tool is not None and Items.FindBySerial(tool.Serial) is not None:
    ...
    Gumps.WaitForGump(949095101, 10000)
    Gumps.SendAction(949095101, 394)
    Misc.Pause(2000)
